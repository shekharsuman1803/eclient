  ...
  it('responds with home page', function (done) {
    ...
    nock("http://localhost:8082")
      ...
      .reply(200, {
        ...
        "events": [
          ...
          { "title": 'another event', id: 5678, "description": 'something even coolerXXXX' }
        ]
      });
    ...
    request(app)
      ...
      .end((err, res) => {
        ...
        chai.assert.isTrue(res.text.includes("<h1 align = \"center\">Welcome to Ninja's application</h1>"));
        return done();
      });
